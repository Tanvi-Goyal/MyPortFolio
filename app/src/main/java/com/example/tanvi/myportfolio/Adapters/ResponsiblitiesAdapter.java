...
public class ResponsiblitiesAdapter extends RecyclerView.Adapter<ResponsiblitiesAdapter.ViewHolder> {

    private List<ResponsiblitiesDataClass> mData;
    ...
    public ResponsiblitiesAdapter(Context context, ArrayList<ResponsiblitiesDataClass> responsiblities) {
        this.mInflater = LayoutInflater.from(context);
        this.mData = responsiblities;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        final ResponsiblitiesDataClass current = mData.get(i);
        ...
        viewHolder.more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showMore(viewHolder.itemView.getContext() , current.getTitle() , current.getInstitution() , current.getDuration() , current.getDescription() , current.getImage() , current.getCertificate());
            }
        });
    }

    private void showMore(Context context, String title, String instituition, String duration, String description, String image, String certificate) {
        ...
        info_sub_title.setText(instituition);
